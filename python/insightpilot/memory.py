...
def get_memory_dir() -> Path:
    d = Path.home() / ".insightpilot" / "projects" / _project_hash() / "memory"
...
SELECT_MEMORIES_PROMPT = """You are selecting memories that will be useful to a real-time research and monitoring agent as it processes a user's query. You will be given the user's query and a list of available memory files with their filenames and descriptions.
...
- Anything already in INSIGHTPILOT.md
