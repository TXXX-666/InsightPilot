...
class Agent:
    def __init__(
        ...
        *,
        ...
        # the dynamic tail, and INSIGHTPILOT.md + date go into the FIRST user message
        ...
        # INSIGHTPILOT_SDK_MAX_RETRIES=0 to isolate our _with_retry in tests.
        _sdk_retries: dict[str, Any] = {}
        _rv = os.environ.get("INSIGHTPILOT_SDK_MAX_RETRIES")
    ...
    async def _classify_tool_call(self, tool_name: str, inp: dict) -> dict:
        ...
        *could* apply); if stage 1 allows, we're done in one call. If stage 1
        ...
        try:
            ...
            # INSIGHTPILOT.md rides in the user message, not the system prompt — it is
    ...
    def _persist_large_result(self, tool_name: str, result: str) -> str:
        ...
        if len(result.encode()) <= THRESHOLD:
            return result
        d = Path.home() / ".insightpilot" / "tool-results"
    ...
    def _generate_plan_file_path(self) -> str:
        d = Path.home() / ".insightpilot" / "plans"
        d.mkdir(parents=True, exist_ok=True)
...
IMPORTANT: When your plan is complete, you MUST call exit_plan_mode. Do NOT ask the user to approve — exit_plan_mode handles that."""
    ...
    def _push_anthropic_user_message(self, content: str) -> None:
        """Push a user message, prepending the INSIGHTPILOT.md/date <system-reminder>
